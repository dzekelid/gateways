...
- name: Azure Virtual Network API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/gateways/master/_listings/azure-virtual-network/subscriptions-subscriptionid-providers-microsoft-network-applicationgateways-get.md
x-common:
